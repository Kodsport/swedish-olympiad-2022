...
\fe{Förklaring: } Det finns inga korta vokaler i meningen.
...
\fe{Förklaring: } Det andra \emph{e}:et i ordet \emph{leende} räknas som kort vokal och utelämnas därför. Notera att det första \emph{e}:et ska stå kvar eftersom det inte var en kort vokal i den ursprungliga meningen.
